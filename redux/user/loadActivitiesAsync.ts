...
const loadActivitiesAsync =
  () => async (dispatch: Dispatch<any>, getState: () => RootState) => {
    dispatch(appendLog(`started loadActivitiesAsync`));
    ...
    // console.log(
    //   '🚀 ~ file: loadActivitiesAsync.ts ~ line 36 ~ activities',
    //   activities?.data
    // );
    if (activities?.data) {
      ...
      //   console.log(
      //     '🚀 ~ file: loadActivitiesAsync.ts ~ line 43 ~ lastTimestamp',
      //     lastTimestamp,
      ...
      //   console.log(
      //     '🚀 ~ file: loadActivitiesAsync.ts ~ line 52 ~ activities.forEach ~ count',
      //     count
      //   );
      dispatch(
        appendLog(`finished loadActivitiesAsync with a new count of ${count}`)
      );
    }
...
export default loadActivitiesAsync;
